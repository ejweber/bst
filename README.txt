This implementation of a binary search tree was written in Java to fulfill a requirement for CS 721 
at Wichita State University. It is intended to be compiled and run on the Computer Science 
Department's McCoy server, which (for some unknown reason) runs javac and java version 1.6.0_38 in 
